...
| `claude-review-file.sh` | Claude Review File | Review the currently focused file with Claude Code (auto-research + suggestions) |
...
| `toggle-microphone.applescript` | Toggle Microphone | - |
